...
* **December 2020**: [Katy Christensen](https://www.ocean.washington.edu/home/Katy%20Christensen) and I just finished co-teaching OCEAN 215, an introductory Python data analysis course. We adopted a flipped, virtual format and redesigned the course to incorporate a variety of evidence-based teaching practices. Our course website can be accessed [at this link](https://ethan-campbell.github.io/OCEAN_215/); all recorded lessons and other materials are available for reuse. We will be sharing some of what we learned at UW's Symposium on Teaching and Learning (see [here](https://uw.manifoldapp.org/projects/2021-teaching-learning-symposium/resource/cracking-the-code) for our poster and recorded presentation). Stay tuned for a forthcoming paper on our work!
